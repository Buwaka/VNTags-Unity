...
namespace CharlieMadeAThing.NeatoTags.Core
{
    public static class NeatoTagsExtensions
    {
        ...
        {
            return gameObject && Tagger.HasTagger(gameObject);
        }
        ...
        public static int GetTagCount(this GameObject gameObject)
        {
            ...
            return !Tagger.TryGetTagger(gameObject, out Tagger tagger) ? 0 : tagger.GetTagCount();
        }
        ...
        public static bool IsTagged(this GameObject gameObject)
        {
            ...
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.IsTagged();
        }
        ...
        {
            return gameObject && Tagger.TryGetTagger(gameObject, out Tagger tagger) ? tagger.FilterTags() : null;
        }
        ...
        public static NeatoTag GetOrCreateTag(this GameObject gameObject, string newTagName)
        {
            ...
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) ? tagger.GetOrCreate(newTagName) : null;
        }
        ...
        public static bool TryGetTag(this GameObject gameObject, string tagName, out NeatoTag foundTag)
        {
            ...
            if (!Tagger.TryGetTagger(gameObject, out Tagger tagger)) return false;
            if (!tagger.TryGetTag(tagName, out NeatoTag tag)) return false;
            foundTag = tag;
            return true;
        }
        ...
        private static void AddTag(GameObject gameObject, NeatoTag tag, bool addTaggerComponentIfNone)
        {
            if (!gameObject)
            {
            ...
            if (Tagger.TryGetTagger(gameObject, out Tagger tagger))
            {
                tagger.AddTag(tag);
            }
        ...
        private static void AddTags(this GameObject gameObject, IEnumerable<NeatoTag> tags, bool addTaggerComponentIfNone)
        {
            if (tags == null)
            {
        ...
        {
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.HasTag(tag);
        }
        ...
        {
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.HasTag(tagName);
        }
        ...
        {
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.AnyTagsMatch(tagParams);
        }
        ...
        {
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.AnyTagsMatch(tagNameParams);
        }
        ...
        {
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.AnyTagsMatch(tagList);
        }
        ...
        {
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.AllTagsMatch(tagParams);
        }
        ...
        {
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.AllTagsMatch(tagNameParams);
        }
        ...
        {
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.AllTagsMatch(tagList);
        }
        ...
        {
            return Tagger.TryGetTagger(gameObject, out Tagger tagger) && tagger.AllTagsMatch(tagNameList);
        }
        ...
        public static bool HasNoTagsMatching(this GameObject gameObject, params NeatoTag[] tagList)
        {
            ...
            return !Tagger.TryGetTagger(gameObject, out Tagger tagger) || tagger.NoTagsMatch(tagList);
        }
        ...
        {
            //If there is no tagger, then it is not tagged with any of the given tags.
            return !Tagger.TryGetTagger(gameObject, out Tagger tagger) || tagger.NoTagsMatch(tagNameList);
        }
