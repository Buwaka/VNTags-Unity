...
namespace CharlieMadeAThing.NeatoTags.Core
{
    ...
    public static class TaggerRegistry
    {
        ...
        private static readonly Dictionary<GameObject, Tagger> s_taggers = new();
        ...
        private static readonly Dictionary<NeatoTag, HashSet<GameObject>> s_taggedObjects = new();

        // All gameobjects in the scene that have a Tagger component but no tags (@runtime).
        private static readonly HashSet<GameObject> s_nonTaggedObjects = new();
        ...
        public static void InitializeNewTagger(GameObject gameObject, Tagger tagger)
        {
            ...
            foreach (NeatoTag neatoTag in tagger.GetTags)
            {
        ...
        private static void RegisterTagger(GameObject gameObject, Tagger tagger)
        {
            if (!gameObject || !tagger)
            {
        ...
        private static void UnregisterTagger(GameObject gameObject)
        {
            if (!gameObject)
            {
        ...
        public static void UnregisterTag(NeatoTag tagToUnregister)
        {
            ...
            foreach (GameObject gameObject in s_taggedObjects[tagToUnregister])
            {
        ...
        private static void UnregisterGameObjectFromTag(GameObject gameObject, NeatoTag tag)
        {
            if (!gameObject || !tag)
            {
        ...
        private static void UnregisterNonTaggedGameObject(GameObject gameObject)
        {
            if (!gameObject)
            {
