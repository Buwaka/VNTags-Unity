...
{
    [CustomPropertyDrawer(typeof(PropertyRequireComponentAttribute))]
    public class PropertyRequireComponent : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var  requiredAttribute = attribute as PropertyRequireComponentAttribute;
